...
if (isset($_POST['simpan'])) {
    ...
    if (empty($sekolah) || empty($alamat) || empty($namafile)) {
        ...
        $sql = "INSERT INTO tbl_sekolah (nama, alamat, foto) VALUES ('$sekolah', '$alamat', '$namaFileBaru')";
        ...
        <div class="col-lg-6 m-3">
            <form class="card p-4 shadow-sm" method="post" id="formMahasiswa" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="txtnamasekolah" id="inputPassword3">
                    </div>
                </div>
                <div class="row mb-3">
