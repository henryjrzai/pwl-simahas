...
if (isset($_GET['action'])) {
    if ($_GET['action'] == "hapus") {
        $id = $_GET['id'];
        $sql = mysqli_query($kws, "DELETE FROM tbl_sekolah WHERE id = '$id'");
        if ($sql) {
...
<section id="tampilMahasiswa">
    <div class="header">
        <h2 class="fw-bolder">Data Sekolah</h2>
        <a href="index.php?page=_admSekolah" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square-fill me-3 mb-1" viewBox="0 0 16 16">
    ...
    <div class="table-data mt-3">
        <table id="myTable" class="display table table-striped table-responsive table-hover">
            ...
            <tbody>
            <?php
            $query = mysqli_query($kws, "SELECT * FROM tbl_sekolah");
            while($result = mysqli_fetch_assoc($query)){
                ...
                <tr>
                    ...
                    <td class="w-25"><img class="img-thumbnail w-10" src="file/<?php echo $result['foto']?>" alt=""></td>
                    <td>
                        <a href="index.php?page=_editSekolah&id=<?php echo $result['id']?>" class="btn btn-success">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                            </svg>
                        </a>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $result['id']?>">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Apakah anda yakin menghapus data sekolah ?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                        <a id="liveToastBtn" class="btn btn-danger" href="index.php?page=_tampDataSekolah&action=hapus&id=<?php echo $result['id']; ?>">Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
